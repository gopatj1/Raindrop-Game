...
public class AssetLoader {
    ...
    public static void load() { //загружаем ассеты
        ...
        //создадим переменую для хранения выбранной сложности со значением по умолчанию 1, если раньше ее не существовало
        if (!prefs.contains("difficult")) {
            prefs.putInteger("difficult", 0).flush(); //получает новое значение и сохраняет (сложный уровень)
        }
